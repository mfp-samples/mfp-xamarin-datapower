	...
	public class HomePage : ContentPage
	{
		...
		public HomePage ()
		{
			...
			listView.ItemsSource = new [] {
				...
				new CommandItem { Command = "Invoke DataPower", Image = "invoke.png", ItemSelected = OnInvokeDataPower },
		...
		private async void OnInvokeDataPower()
		{
			ShowWorking();
			App.WorklightClient.client.RegisterChallengeHandler(DataPowerChallengeHandler.GetInstance());
			var result = await App.WorklightClient.ProtectedInvokeAsync();
			await HandleResult(result, "DataPower adapter invocation Result", true);
